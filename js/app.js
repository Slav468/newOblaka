        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            function hideMenuItem() {
                ...
                for (let menu of menus) {
                    ...
                    if (totalWidthItem + 110 < width && menuListChildren.length < 8 && menuLastItemListChildren.length > 1) menuBackItem(menuList, menuLastItemList, menuLastItemListChildren);
                }
            }
